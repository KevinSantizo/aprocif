(function ($) {
  ...
  */
  ...
  $(document).ready(function() {
    ...
    var $validation = '[name="name"],[name="surname"],[name="email"],[name="number"],[name="country"],[name="phone_code"],[name="topic"],[name="enterprice"],[name="sector"],[name="message"]'; // Must be use (,) without any space
